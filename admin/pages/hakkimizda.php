                                ...
                                <div class="col-lg-6">
                                    <form role="form" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="3" placeholder="Açıklama..." name="aciklama" id="mytextarea"><?=$row["aciklama"]?></textarea>
                                        </div>
                                      
                                        
                                       
                                        <input type="submit" name="submit"class="btn btn-default" value="KAYDET">
                                        <input type="reset" name="reset" class="btn btn-default" value="TEMİZLE">
                                    </form>
                                </div>
